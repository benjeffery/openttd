...
const SaveLoad *GetGoodsDesc()
{
	static const SaveLoad goods_desc[] = {
		...
		SLEG_CONDVAR(            _cargo_feeder_share, SLE_INT64,                  65, 67),
		 ...
		 SLE_CONDVAR(GoodsEntry, cargo_counter,       SLE_UINT16,                175, SL_MAX_VERSION),
		 SLE_CONDLST(GoodsEntry, cargo.packets,       REF_CARGO_PACKET,           68, SL_MAX_VERSION),
		 SLE_CONDVAR(GoodsEntry, cargo.next_start,    SLE_UINT32,                175, SL_MAX_VERSION),
		 SLE_CONDLST(GoodsEntry, routes,              REF_ROUTE_LINK,            175, SL_MAX_VERSION),
