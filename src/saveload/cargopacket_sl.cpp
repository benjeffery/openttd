...
const SaveLoad *GetCargoPacketDesc()
{
	static const SaveLoad _cargopacket_desc[] = {
		 ...
		 SLE_CONDVAR(CargoPacket, dest_xy,         SLE_UINT32, 175, SL_MAX_VERSION),
		 SLE_CONDVAR(CargoPacket, dest_id,         SLE_UINT16, 175, SL_MAX_VERSION),
		 SLE_CONDVAR(CargoPacket, dest_type,       SLE_UINT8,  175, SL_MAX_VERSION),
		 SLE_CONDVAR(CargoPacket, flags,           SLE_UINT8,  175, SL_MAX_VERSION),
		 SLE_CONDVAR(CargoPacket, next_order,      SLE_UINT16, 175, SL_MAX_VERSION),
		 SLE_CONDVAR(CargoPacket, next_station,    SLE_UINT16, 175, SL_MAX_VERSION),
